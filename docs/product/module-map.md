...
**Not built yet:** Stripe webhooks wired to Laravel HTTP layer, reconciliation jobs, VAT reporting exports, FX.
...
**Not built yet:** SPA/admin/account API surface, tenancy authorization rules, webhook handlers under `routes` group.
