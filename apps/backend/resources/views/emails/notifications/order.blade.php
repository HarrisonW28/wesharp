@php
  ...
  /** @var string|null $orderReference */
      ...
      <div style="background:#ffffff;border:1px solid #e6e7ea;border-radius:12px;padding:20px;">
        ...
        @if(!empty($portalUrl))
          ...
          <p style="margin:0;font-size:12px;color:#6b7280;">
            Sign in to your portal and match this email to the order reference above — we don’t put account links with internal IDs in emails.
          </p>
        @endif
