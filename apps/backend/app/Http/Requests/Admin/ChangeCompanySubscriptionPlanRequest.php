...
final class ChangeCompanySubscriptionPlanRequest extends FormRequest
{
    ...
    {
        return [
            'subscription_plan_id' => ['required', 'uuid', Rule::exists('subscription_plans', 'id')],
            'effective_starts_at' => ['required', 'date'],
            'renews_at' => ['sometimes', 'nullable', 'date', 'after_or_equal:effective_starts_at'],
