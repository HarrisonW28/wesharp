        ...
        {(rulesQuery.data ?? []).length === 0 && !rulesQuery.isPending ? (
          <Card className="border-dashed sm:col-span-2 xl:col-span-3">
            <CardHeader>
              ...
              <CardDescription>
                Create a per-knife rule for each coverage band you serve, or one global rule. Subscription catalogue prices stay under Plans &amp; subscriptions.
              </CardDescription>
            </CardHeader>
          </Card>
        ) : null}
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-h-[min(90vh,40rem)] overflow-y-auto sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              First-visit per-blade price applies until the company has a completed, invoiced, or returned order — then the standard rate is used automatically.
            </DialogDescription>
          </DialogHeader>
