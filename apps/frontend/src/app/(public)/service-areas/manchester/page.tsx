        ...
        <IconFeatureGrid
          ...
          features={[
            ...
            },
            {
              ...
              description: "Most Manchester collections returned within a few working days.",
            },
          ]}
        />
            ...
            features={[
              {
                ...
                description: (
                  <>
                    <strong className="font-medium text-foreground">Mobile knife sharpening Manchester</strong>: collection and
