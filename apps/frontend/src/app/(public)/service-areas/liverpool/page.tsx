...
import {
  ...
  LIVERPOOL_H1,
  LIVERPOOL_LEAD,
  LIVERPOOL_META_DESCRIPTION,
  LIVERPOOL_PAGE_TITLE,
  liverpoolFaqSchema,
  liverpoolLocalBusinessSchema,
} from "@/config/service-area-liverpool-content";

export const metadata: Metadata = {
  title: LIVERPOOL_PAGE_TITLE,
  description: LIVERPOOL_META_DESCRIPTION,
  alternates: {
    canonical: "/service-areas/liverpool",
  },
  openGraph: {
    title: `WeSharp — ${LIVERPOOL_H1}`,
    description: LIVERPOOL_META_DESCRIPTION,
    type: "website",
  },
};
...
export default function LiverpoolServiceAreaPage() {
  return (
    <>
      <JsonLd data={liverpoolFaqSchema(LIVERPOOL_FAQS)} />
      ...
      <MarketingArticle title={LIVERPOOL_H1} lead={LIVERPOOL_LEAD} showFooterCtas={false}>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            <strong className="font-medium text-foreground">knife sharpening Merseyside</strong> means the postcodes we accept on
            our live checker, from the waterfront to the surrounding boroughs of the Liverpool City Region.
          </p>
          <p>
            In <strong className="font-medium text-foreground">Liverpool city centre</strong> we collect from apartments, serviced
            kitchens, and restaurant back-of-house with agreed time windows. Across the Mersey,{" "}
            <strong className="font-medium text-foreground">Wirral</strong> and{" "}
            <strong className="font-medium text-foreground">Birkenhead</strong> see regular driver rounds through Heswall,
            West Kirby, and the Wirral Peninsula. North along the coast,{" "}
            <strong className="font-medium text-foreground">Crosby</strong>,{" "}
            <strong className="font-medium text-foreground">Formby</strong>, and{" "}
            <strong className="font-medium text-foreground">Southport</strong> are on the same collection-and-return model.
          </p>
          <p>
            Inland, we serve <strong className="font-medium text-foreground">Knowsley</strong>,{" "}
            <strong className="font-medium text-foreground">Sefton</strong>, and{" "}
            <strong className="font-medium text-foreground">St Helens</strong> on scheduled rounds.{" "}
            <strong className="font-medium text-foreground">Bootle</strong> and the docks corridor sit comfortably within our
            Liverpool City Region routes. South Liverpool neighbourhoods —{" "}
            <strong className="font-medium text-foreground">Woolton</strong>,{" "}
            <strong className="font-medium text-foreground">Allerton</strong>, and{" "}
            <strong className="font-medium text-foreground">Aigburth</strong> — are well served for home cooks and independent
            restaurants. Wherever you are, drop your postcode into the checker below before you{" "}
          ...
          <p>
            Terrace kitchens in Anfield, new-build flats around the waterfront, and suburban homes in Maghull all use the same
            booking flow: postcode check, collection window, bag handover at the door. We route drivers through the Liverpool City
            Region on scheduled rounds rather than ad-hoc trips, which keeps timing realistic and costs transparent.
          </p>
          <p>
            We also run the same service east of the Pennines — see our{" "}
            <Link href="/service-areas/manchester" className="font-medium text-foreground underline underline-offset-4">
              knife sharpening in Manchester
            </Link>{" "}
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc space-y-2 pl-5">
            <li>
              ...
              <strong className="font-medium text-foreground">chef knife sharpening Liverpool</strong> for brigades and home cooks.
            </li>
            <li>
          ...
          <p>
            <strong className="font-medium text-foreground">Japanese knife sharpening Liverpool</strong> customers often ask about
        ...
        <section className="space-y-5">
          ...
          <p>
            ...
            knows your building or site access notes. That combination is why repeat bookings across Liverpool outnumber one-off
        ...
        <section className="space-y-4">
          ...
          <FaqAccordion items={LIVERPOOL_FAQS} />
          <p className="text-sm">
        ...
        <section className="space-y-4 rounded-2xl border bg-muted/25 p-5 md:p-6">
          <h2 className="text-lg font-semibold text-foreground">Book Knife Sharpening in Liverpool</h2>
          <p>
        ...
        <section className="rounded-xl border bg-card p-4 md:p-5">
          ...
          <ul className="mt-3 list-inside list-disc space-y-1 text-sm text-muted-foreground md:text-base">
            <li>
              <Link href="/service-areas/manchester" className="font-medium text-primary underline-offset-4 hover:underline">
                Knife sharpening in Manchester
              </Link>
              <span className="text-muted-foreground"> — Greater Manchester</span>
            </li>
          </ul>
