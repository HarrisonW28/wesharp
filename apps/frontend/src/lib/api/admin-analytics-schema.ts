...
export const AnalyticsOverviewResponseSchema = analyticsEnvelope(
  z.object({
    kpis: z.object({
      ...
      invoiced_subscription_total_pence_in_range: z.number(),
      invoiced_one_off_total_pence_in_range: z.number(),
      invoiced_subscription_line_pence_in_range: z.number(),
      invoiced_overage_line_pence_in_range: z.number(),
      completed_orders_in_filter_range: z.number(),
      average_knives_per_completed_order_in_range: z.number().nullable(),
    }),
