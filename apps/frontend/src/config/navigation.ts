    ...
    items: [
      {
        ...
        description: "Costs, billing, subscriptions, and KPI overview",
      },
    ],
  },
  {
        ...
        children: [
          {
            ...
            description: "Volume and pricing assumptions with ROI-style payback hints",
          },
          {
            title: "Cash position",
            ...
            icon: PiggyBank,
            permissionAny: ["reports.finance", "costs.view"],
            description: "Capital, spend-to-date, burn, runway, and working assumptions",
          },
          {
            ...
            icon: Calculator,
            permissionAny: ["reports.finance", "costs.view"],
            description: "Subscription vs overage revenue, usage, costs, and margin signals",
          },
          {
            ...
            description: "Checkout funnel, card and manual payments, discounts, and attribution",
          },
          {
            ...
            description: "Profit, cash, runway, recurring revenue, alerts, and drill-down links",
          },
          {
            title: "Sales report",
