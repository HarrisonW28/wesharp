        ...
        children: [
          {
            ...
            icon: Calculator,
            permission: "costs.view",
            description: "Recurring lines, cadence, and workbook-linked rows",
          },
          {
            title: "Cost import",
            href: "/admin/finance/costs/import",
            icon: Upload,
            permission: "costs.view",
            description: "Upload workbook CSV or Excel — preview, validate, commit",
          },
          {
            title: "Consumables",
            ...
            icon: Boxes,
            permission: "costs.view",
            description: "Inventory, usage logging, and restock projections",
          },
          {
            title: "Cost ledger",
            ...
            icon: Coins,
            permission: "costs.view",
            description: "Manual allocations (orders, routes, accounts) — Sprint 23.5",
          },
        ],
      },
        ...
        children: [
          {
            ...
            icon: Percent,
            permissionAny: ["reports.finance", "costs.view"],
            description: "Sprint 24.2 drivers, estimates, ROI & payback buckets",
          },
          {
            title: "Cash position",
            ...
            icon: PiggyBank,
            permissionAny: ["reports.finance", "costs.view"],
            description: "Buffer, burn, runway, and workbook assumptions",
          },
          {
            ...
            icon: Calculator,
            permissionAny: ["reports.finance", "costs.view"],
            description: "Sprint 24.3 — subscription vs overage lines, usage, allocations, and margin heuristics",
          },
          {
            title: "Sales & POS performance",
            href: "/admin/reports/sales-performance",
            icon: ShoppingCart,
            permissionAny: ["reports.finance", "reports.sales_performance"],
            description: "Sprint 24.5 — checkout funnel, POS-like payments, allocations, sales attribution",
          },
          {
            title: "Executive dashboard",
            href: "/admin/reports/executive-dashboard",
            icon: LayoutGrid,
            permissionAny: ["reports.executive_dashboard", "reports.finance"],
            description: "Sprint 24.6 — profit, cash, runway, MRR, alerts and forecast links",
          },
          {
            title: "Sales report",
